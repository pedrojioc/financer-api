...
import { LoanBalanceSnapshot } from '../modules/loan-history/entities/loan-balance-snapshot.entity'
...
export class Loan {
	...
	@OneToMany(() => LoanBalanceSnapshot, (snapshot) => snapshot.loan)
	balanceSnapshots: LoanBalanceSnapshot[]
}
